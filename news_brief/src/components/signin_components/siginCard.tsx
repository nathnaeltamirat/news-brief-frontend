...
return (
  <div className={`relative w-full max-w-xs mx-auto rounded-lg shadow-md p-4 ${bgCard} transition-all duration-300`}>
    ...
    <input
      ...
      className={`w-full mb-2 px-3 py-2 rounded-md border ${inputBg} text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none`}
    />
    ...
    <div className="relative mb-2">
      <input
        ...
        className={`w-full px-3 py-2 rounded-md border ${inputBg} pr-9 text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none`}
      />
      {password && (
        <button
          type="button"
    ...
    <div className="mb-2 text-right">
      <button
        ...
        className="hover:underline font-medium text-xs text-blue-600"
      >
    ...
    <button
      ...
      disabled={loading}
      className={`w-full py-2 rounded-full font-medium ${btnPrimary} disabled:opacity-50 mb-2 text-xs`}
    >
