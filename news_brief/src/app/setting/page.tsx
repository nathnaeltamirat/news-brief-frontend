      ...
      <div className="flex-1 pt-6 md:pt-10 px-4 sm:px-6 lg:px-8 flex justify-center">
        <div className="w-full max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4 md:gap-0">
            <div>
              <h1 className="text-2xl sm:text-3xl font-semibold text-[#27233A]">
                Settings
              </h1>
            </div>
            <button className="bg-[#27233A] text-white px-5 py-2 rounded-lg transition-colors duration-200 w-full md:w-auto hover:bg-[#2F2C44]">
              Save changes
            </button>
          </div>
          ...
          {activeTab === "customization" && (
            <div className="space-y-6">
              <section className="border border-gray-200 bg-white rounded-2xl p-4 sm:p-6 shadow-sm space-y-4 sm:space-y-6">
                <h2 className="text-lg font-medium text-[#27233A]">
                  Customization
                </h2>
                <div>
              ...
              <section className="border border-gray-200 bg-white rounded-2xl p-4 sm:p-6 shadow-sm space-y-4 sm:space-y-6">
                ...
                <div className="border border-gray-200 bg-gray-50 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="bg-[#800000] text-white px-4 py-2 rounded-lg transition text-sm">
                      Delete Account
                    </button>
                  </div>
